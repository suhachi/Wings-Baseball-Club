...
**Generated**: 2025-12-19T06:46:23.689Z
...
## app\components\CreateNoticeModal.tsx
```typescript
import React, { useState } from 'react';
...
## app\components\EditPostModal.tsx
```typescript
...
## app\components\FileUploadModal.tsx
```typescript
...
## app\components\PostDetailModal.tsx
```typescript
import React, { useState, useEffect } from 'react';
import { X, Share2, Edit, Trash2, Pin, Calendar, MapPin, Trophy, Users, MessageCircle, AlertCircle, Bell, Clock, CheckCircle2, XCircle, HelpCircle } from 'lucide-react';
import { motion, AnimatePresence } from 'motion/react';
import { useAuth } from '../contexts/AuthContext';
...
## app\components\ui\toggle-group.tsx
```typescript
"use client";
...
## app\pages\AccessDeniedPage.tsx
```typescript
import React from 'react';
...
## app\pages\AdminPage.tsx_append
```
...
## lib\firebase\events.service.ts
```typescript
...
## lib\firebase\messaging.service.ts
```typescript
