 ...
 * 2. 실행: node scripts/post_v1.1_announcement.cjs
 *    (Emulator 사용 시: export FIRESTORE_EMULATOR_HOST="localhost:8080" && node scripts/post_v1.1_announcement.cjs)
 */
...
async function main() {
    ...
    if (fs.existsSync(SERVICE_ACCOUNT_PATH)) {
        ...
        admin.initializeApp({
            projectId: 'demo-wings' // Demo project ID
        });
    }
