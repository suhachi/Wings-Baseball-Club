...
```json
{
  ...
  "scripts": {
    ...
    "emulators:start:auth-only": "firebase emulators:start --only firestore,auth",
    "release:final": "node scripts/release-final-approval.mjs",
    "release:deploy:all": "node scripts/release-deploy-all.mjs"
  },
  "dependencies": {
